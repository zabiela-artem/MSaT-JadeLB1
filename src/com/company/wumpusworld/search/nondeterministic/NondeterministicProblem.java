...
import com.company.wumpusworld.search.framework.problem.ActionsFunction;
import com.company.wumpusworld.search.framework.problem.GoalTest;
import com.company.wumpusworld.search.framework.problem.StepCostFunction;
...
public class NondeterministicProblem<S, A> {
     ...
     * Constructor
     */
    public NondeterministicProblem(S initialState, ActionsFunction<S, A> actionsFn, ResultsFunction<S, A> resultsFn, GoalTest<S> goalTest) {
     ...
     * Constructor
     */
    public NondeterministicProblem(S initialState, ActionsFunction<S, A> actionsFn, ResultsFunction<S, A> resultsFn, GoalTest<S> goalTest, StepCostFunction<S, A> stepCostFn) {
