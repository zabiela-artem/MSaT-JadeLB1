...
import com.company.wumpusworld.agent.EnvironmentViewNotifier;
...
import com.company.wumpusworld.search.nondeterministic.AndOrSearch;
import com.company.wumpusworld.search.nondeterministic.NondeterministicProblem;
import com.company.wumpusworld.search.nondeterministic.Plan;
...
public class NondeterministicSearchAgent<S, A extends Action> extends AbstractAgent {
    ...
    public void makePlan(NondeterministicProblem<S, A> problem) {
        ...
        currStep = -1;
        if (notifier != null) notifier.notifyViews("Contingency plan: " + contingencyPlan);
    }
    ...
    public Action execute(Percept percept) {
        ...
        // at goal or no plan?
        if (problem.testGoal(state) || contingencyPlan == null) return NoOpAction.NO_OP;
        ...
        if (contingencyPlan.isActionStep(currStep)) return contingencyPlan.getAction(currStep);
