...
public class OptimizedDPLL implements DPLL {
    ...
    public boolean dpll(Set<Clause> clauses, List<PropositionSymbol> symbols, Model model) {
        ...
        if (allTrue) {
            return true;
        } else if (Tasks.currIsCancelled()) return false;
        ...
        return callDPLL(clauses, rest, model, p, true) || callDPLL(clauses, rest, model, p, false);
    }
    ...
    protected boolean callDPLL(Set<Clause> clauses, List<PropositionSymbol> symbols, Model model, PropositionSymbol p, boolean value) {
